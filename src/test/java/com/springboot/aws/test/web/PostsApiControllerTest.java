...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT) // 호스트가 사용하지 않는 random port를 사용하겠다는 의미
public class PostsApiControllerTest {
    ...
    @Autowired
    private TestRestTemplate restTemplate; // 브라우저 확인

    @Autowired
    private PostsRepository postsRepository; // DB체크용
